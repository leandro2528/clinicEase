    ...
    <div class="row py-4">
        ...
        <div class="col-10">
            ...
            <div class="cards d-flex justify-content-between mt-5">
                ...
                <div class="card w-100 mx-3 shadow p-2 mx-2 text-center">
                    <div class="card-total">
                        <h2 class="text-warning">00</h2>
                    </div>
                    <div class="card-title text-secondary">Pacientes confirmados</div>
                    <div class="card-icon">
                ...
                <div class="card w-100 shadow p-2 mx-2 text-center">
                    ...
                    <div class="card-title text-secondary">Pacientes atendidos</div>
                    <div class="card-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#198754" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                ...
                <div class="card w-100 ms-3 shadow p-2 mx-2 text-center">
                        <h2 class="text-danger">00</h2>
                    <div class="card-title text-secondary">Pacientes que faltaram</div>
                    <div class="card-icon">
            ...
            <div class="cards-grafic d-flex justify-content-between mt-5">
                <div class="card w-100 shadow p-2 mx-2 text-center">
                    <div class="card-total text-primary">Paciente</div>
                ...
                <div class="card w-100 shadow p-2 mx-2 text-center">
                    <div class="card-total text-primary">Procedimeto realizado</div>
                    <div class="card-icon my-5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-bar-chart" viewBox="0 0 16 16">
                            <path d="M4 11H2v3h2zm5-4H7v7h2zm5-5v12h-2V2zm-2-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM6 7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1zm-5 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1z"/>
                        </svg>
                ...
                <div class="card w-100 shadow p-2 mx-2 text-center">
                    <div class="card-total text-primary">Paciente X Convênio</div>
                    <div class="card-icon my-5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-bar-chart" viewBox="0 0 16 16">
                            <path d="M4 11H2v3h2zm5-4H7v7h2zm5-5v12h-2V2zm-2-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM6 7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1zm-5 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1z"/>
                        </svg>
                ...
                <div class="card w-100 shadow p-2 mx-2 text-center">
                    <div class="card-total text-primary">Duração do atendimento</div>
                    <div class="card-icon my-5">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-bar-chart" viewBox="0 0 16 16">
                            <path d="M4 11H2v3h2zm5-4H7v7h2zm5-5v12h-2V2zm-2-1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM6 7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1zm-5 4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1z"/>
                        </svg>
